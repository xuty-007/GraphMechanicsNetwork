...
if args.config_by_file:
    job_param_path = 'simple_config.json'
...
def main():
    ...
    dataset_train = NewNBodyMStickDataset(partition='train', dataset_name=args.dataset,
    ...
    dataset_val = NewNBodyMStickDataset(partition='val', dataset_name="nbody_small", n_isolated=n_isolated,
                                        n_stick=n_stick, n_hinge=n_hinge, data_dir=args.data_dir)
